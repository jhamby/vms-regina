...
CFLAGSPLUS=$(ARCHFLAGSPLUS)$(COMMON_CFLAGS)/PLUS_LIST

.ELSE
! Note: /PLUS_LIST makes speed and code size both worse on Itanium.
ARCHFLAGS=/ARCH=HOST/OPT=(LEV=5)
CFLAGSPLUS=$(ARCHFLAGS)$(COMMON_CFLAGS)$(WARN_CFLAGS)
